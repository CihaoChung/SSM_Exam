...
<script type="text/javascript">
    ...
    function upload() {
        ...
        $.ajax({
            url: '${pageContext.request.contextPath}/after/question/upload_file.action',
            type: 'post',
            data: formData,
            contentType: false,
            processData: false,
    ...
    $('#search-subject').combobox({
        url:"${pageContext.request.contextPath}/after/question/findSubject.action",
        valueField:'id',
        textField:'name',
        panelheight: "200"
    });
    ...
    function add(type) {
        ...
        $.ajax({
            url: '${pageContext.request.contextPath}/after/question/add.action',
            dataType: 'json',
            type: 'post',
            data: data,
            success: function (data) {
    ...
    function edit(id,subjectid) {
        ...
        $.ajax({
            url: '${pageContext.request.contextPath}/after/question/edit.action',
            dataType: 'json',
            type: 'post',
            data: data,
            success: function (data) {
    ...
    function remove() {
        $.messager.confirm('信息提示', '确定要删除该记录？', function (result) {
            if (result) {
                ...
                $.ajax({
                    url: '${pageContext.request.contextPath}/after/question/delete.action',
                    dataType: 'json',
                    type: 'post',
                    data: {id: item.id},
                    success: function (data) {
...
//        alert(subjectid);
        ...
        $('#Showquestion-dialog').dialog({
            ...
            buttons: [{
                ...
                handler: function () {
                    ...
                    //修改题目
                    $.ajax({
                        url: '${pageContext.request.contextPath}/after/question/edit.action?questionId='+questionId,
                        dataType: 'json',
                        type: 'post',
                        data: data,
                        success: function (data) {
            ...
            onBeforeOpen: function (data) {
                        $.ajax({
                            url: '${pageContext.request.contextPath}/after/question/findQuestionById.action?questionId=' + questionId,
                            type: "post",
                            dataType: 'json',
                            async: false,
                            success: function (data) {
    ...
    $('#data-datagrid').datagrid({
        url: '${pageContext.request.contextPath}/after/question/list.action',
        rownumbers:true,
        singleSelect:true,
        pageSize:20,
        pagination:true,
