...
<script type="text/javascript">
	...
	*/
	...
	function edit(){
		...
		$.ajax({
			url:'${pageContext.request.contextPath}/after/student/edit.action',
			dataType:'json',
			type:'post',
			data:data,
			success:function(data){
	...
	function remove(){
		$.messager.confirm('信息提示','确定要删除该记录？', function(result){
			if(result){
				...
				$.ajax({
					url:'${pageContext.request.contextPath}/after/student/delete.action',
					dataType:'json',
					type:'post',
					data:{id:item.id},
					success:function(data){
	...
	*/
	$('#data-datagrid').datagrid({
		url:'${pageContext.request.contextPath}/after/student/list.action',
		rownumbers:true,
		singleSelect:true,
		pageSize:20,           
		pagination:true,
