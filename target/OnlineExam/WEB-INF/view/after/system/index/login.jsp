...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/resources/admin/easyui/easyui/1.3.4/themes/icon.css" />
    ...
    <div class="login" style="display: block;">
        ...
        <div class="login-center clearfix">
            ...
            <div class="login-center-input">
                <input type="text" name="name" id="name" value="wadewhy" placeholder="请输入您的用户名" onfocus="this.placeholder=&#39;&#39;" onblur="this.placeholder=&#39;请输入您的用户名&#39;">
        ...
        <div class="login-center clearfix">
            ...
            <div class="login-center-input">
                <input type="password" name="pwd" id="pwd" value="123456" placeholder="请输入您的密码" onfocus="this.placeholder=&#39;&#39;" onblur="this.placeholder=&#39;请输入您的密码&#39;">
                <div class="login-center-input-text">密码</div>
            </div>
        </div>
        <div class="login-center clearfix">
            <div class="login-center-img"><img src="${pageContext.request.contextPath}/resources/admin/login/images/cpacha.png"></div>
            <div class="login-center-input">
                ...
                <img id="cpacha-img" title="点击切换验证码" style="cursor:pointer;" src="${pageContext.request.contextPath}/after/login/getCode.action" width="110px" height="30px" onclick="this.src=this.src+'?'">
            </div>
        </div>
...
<script type="text/javascript">
    ...
    document.querySelector(".login-button").onclick = function(){
        ...
        $.ajax({
            url:'${pageContext.request.contextPath}/after/login/login.action',
            ...
            success:function(data){
                if(data.code == 200){
                    $.messager.alert('登录消息', data.msg ,'info', function (fn) {
                        ...
                        location.href = "${pageContext.request.contextPath}/after/sys/index.action";
                    });
                    // showMsg(data.msg);
                    ...
                    $.get("/after/login/getCode.action",function () {
                        $("#cpacha-img").attr("src","${pageContext.request.contextPath}/after/login/getCode.action");
                    })
                }
            }
        });
