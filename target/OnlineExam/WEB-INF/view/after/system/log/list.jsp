...
<script type="text/javascript">
	...
	*/
	function add(){
		...
		$.ajax({
			url:'${pageContext.request.contextPath}/after/log/add.action',
			dataType:'json',
			type:'post',
			data:data,
	...
	function remove(){
		$.messager.confirm('信息提示','确定要删除该记录？', function(result){
			if(result){
				...
				$.ajax({
					url:'${pageContext.request.contextPath}/after/log/delete.action',
					dataType:'json',
					type:'post',
					data:{ids:ids},
					success:function(data){
	...
	*/
	$('#data-datagrid').datagrid({
		url:'${pageContext.request.contextPath}/after/log/list.action',
		rownumbers:true,
		singleSelect:false,
		pageSize:20,           
		pagination:true,
