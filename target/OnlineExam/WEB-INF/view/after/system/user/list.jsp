        ...
        <table>
            <tr>
                ...
                <td valign="middle">
                    <img id="preview-photo" style="float:left;"
                         src="${pageContext.request.contextPath}/resources/admin/easyui/images/user_photo.jpg" width="100px">
            ...
            <tr>
                ...
                <td><input type="text" id="add-photo" name="imgpath"
                           value="${pageContext.request.contextPath}/resources/admin/easyui/images/user_photo.jpg" readonly="readonly"
                           class="wu-text "/></td>
            </tr>
            <tr>
...
<script type="text/javascript">
    ...
    function upload() {
        ...
        $.ajax({
            url: '${pageContext.request.contextPath}/after/user/upload_photo.action',
            type: 'post',
            data: formData,
            contentType: false,
            processData: false,
    ...
    function add() {
        ...
        $.ajax({
            url: '${pageContext.request.contextPath}/after/user/add.action',
            dataType: 'json',
            type: 'post',
            data: data,
            success: function (data) {
    ...
    function edit() {
        ...
        $.ajax({
            url: '${pageContext.request.contextPath}/after/user/edit.action',
            dataType: 'json',
            type: 'post',
            data: data,
            success: function (data) {
    ...
    function remove() {
        $.messager.confirm('信息提示', '确定要删除该记录？', function (result) {
            if (result) {
                ...
                $.ajax({
                    url: '${pageContext.request.contextPath}/after/user/delete.action',
                    dataType: 'json',
                    type: 'post',
                    data: {ids: ids},
                    success: function (data) {
        ...
        $('#select-role-dialog').dialog({
            ...
            buttons: [{
                ...
                handler: function () {
                    ...
                    //提交选择的角色
                    $.ajax({
                        url: '${pageContext.request.contextPath}/after/user/add_role_user.action?uid='+userId,
                        type: "post",
            ...
            onBeforeOpen: function () {
                ...
                $('#role-datagrid').datagrid({
                    url: '${pageContext.request.contextPath}/after/role/findAllRole.action',
                    multiSort: true,
                    idField: 'id',
                    treeField: 'name',
                    fit: true,
                    ...
                    onLoadSuccess: function (data) {
                        $.ajax({
                            url: '${pageContext.request.contextPath}/after/role/findRoleByUid.action?uid=' + userId,
                            type: "post",
                            dataType: 'json',
                            success: function (data) {
                                if (data.code == 200) {
    ...
    $('#data-datagrid').datagrid({
        url: '${pageContext.request.contextPath}/after/user/list.action',
        // rownumbers: true,
        singleSelect: true,
        pageSize: 20,
        pagination: true,
        ...
        columns: [[
            ...
            { field:'roleId',title:'所属角色',formatter:function(value,row,index){
                    $.ajax({
                        url: '${pageContext.request.contextPath}/after/role/findRoleByUid.action?uid=' +row.id,
                        type: "post",
                        dataType: 'json',
                        async: false,
                        success: function (data) {
