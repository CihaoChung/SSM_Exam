...
<div id="select-authority-dialog" class="easyui-dialog" data-options="closed:true,iconCls:'icon-save'"
    ...
    <ul id="authority-tree" url="${wadewhy}/after/role/get_all_menu.action" checkbox="true"></ul>
</div>
...
<script type="text/javascript">
    ...
    function add() {
        ...
        // alert(data);
        $.ajax({
            url: '${wadewhy}/after/role/add.action',
            dataType: 'json',
            type: 'post',
            data: data,
    ...
    function edit() {
        ...
        // alert(data);
        $.ajax({
            url: '${wadewhy}/after/role/edit.action',
            dataType: 'json',
            type: 'post',
            data: data,
            success: function (data) {
    ...
    function remove() {
        $.messager.confirm('信息提示', '确定要删除该记录？', function (result) {
            if (result) {
                ...
                $.ajax({
                    url: '${wadewhy}/after/role/delete.action',
                    dataType: 'json',
                    type: 'post',
                    data: {id: item.id},
                    success: function (data) {
    ...
    function selectAuthority(roleId) {
        $('#select-authority-dialog').dialog({
            ...
            buttons: [{
                ...
                handler: function () {
                    ...
                    if (ids != '') {
                        ...
                        $.ajax({
                            url: '${wadewhy}/after/role/add_role_permission.action',
                            type: "post",
            ...
            onBeforeOpen: function () {
                ...
                //首先获取该角色已经拥有的权限
                $.ajax({
                    url: '${wadewhy}/after/role/get_role_permission.action',
                    data: {id: roleId},
                    type: 'post',
                    checkbox:true,
                    dataType: 'json',
    ...
    $('#data-datagrid').datagrid({
        url: '${wadewhy}/after/role/list.action',
        rownumbers: true,
        singleSelect: true,
        pageSize: 20,
        pagination: true,
