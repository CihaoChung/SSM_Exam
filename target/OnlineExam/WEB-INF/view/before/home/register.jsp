	...
	<div class="tm_login_container">
    	<div class="tm_login_form">
			<div class="tm_login_title">
				...
				<div style="margin-top:10px">
					<button type="button" class="tm_btn tm_btn_primary" style="width:50%" onclick="tm.doLogin();">注册</button>
		...
		<script type="text/javascript">
			...
			var tm = {
                ...
                console.log(data);
                $.ajax({
                    url:'${pageContext.request.contextPath}/after/student/add.action',
                    dataType:'json',
                    type:'post',
                    data:data,
                    success:function(data){
                        if(data.type == 'success'){
                            ...
                            window.location="${pageContext.request.contextPath}/before/sys/toLogin.action";
                        }else{
