...
<%@include file="../common/header.jsp"%>
	<style>
		.tm_login_body{
			background:url('${pageContext.request.contextPath}/resources/home/images/001.jpg');
...
<body class="tm_login_body">
    	...
    	<div class="tm_login_form">
			<div class="tm_login_title">
				<table border="0" cellpadding="0" cellspacing="0" class="tm_login_title_table">
					<tbody>
					<tr>
						<th><img src="${pageContext.request.contextPath}/resources/home/images/logo_min.png" align="absmiddle"></th>
            ...
            <table border="0" cellpadding="5" cellspacing="0" class="tm_login_table">
				...
				<tr>
					...
					<th ><img src="${pageContext.request.contextPath}/resources/admin/login/images/cpacha.png" style="margin-top: 13px"></th>
					<td >
						...
						<img id="cpacha-img" title="点击切换验证码" style="" src="${pageContext.request.contextPath}/after/login/getCode.action"  onclick="this.src=this.src+'?'"  >
						</div>
					</td>
    ...
    $(document).ready(function () {
		...
		var tm = {
			...
			goRegister : function(){
				window.location="${pageContext.request.contextPath}/before/sys/register.action";
			},
			doLogin : function(){
				...
				$.ajax({
					type: "POST",
					url: "${pageContext.request.contextPath}/before/home/login.action",
					dataType: "json",
					data: {"name":username, "password":userpass,"cpacha":cpacha},
					success: function(data){
						if(data.code == 200){
							window.location="${pageContext.request.contextPath}/before/sys/toIndex.action";
						}else{
							alert(data.msg);
