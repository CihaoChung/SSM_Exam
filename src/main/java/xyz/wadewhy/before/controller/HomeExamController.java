...
public class HomeExamController {
    ...
    public Map<String, String> startExam(Integer examId, HttpServletRequest request){
        ...
        if(exam.getMuiltquestionnum() > 0){
            ...
            for (Question q: muiltQuestionList
                ...
                System.err.println("【muiltQuestionList】："+q.toString());
            }
     ...
     * @param studentId
     */
    private void insertQuestionToExamPaperCreate(List<Question> questionList,Integer examId,Integer examPaperId,Integer studentId){
        for(Question question:questionList){
    ...
    @ResponseBody
    public Map<String, String> submitExam(Integer examId,Integer examPaperId,String questionString,HttpServletRequest request){
