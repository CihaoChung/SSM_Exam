...
//        System.err.println(question.toString());
     ...
     */
    @RequestMapping("list")
    public Map<String, Object> list(@RequestParam(name = "title",required = false, defaultValue = "") String title,
            @RequestParam(name = "questionType", required = false) Integer questionType,
            @RequestParam(name = "subjectid", required = false) Integer subjectId, Page page) {
        ...
        logger.info("-------list---------subjectId:" + subjectId);
