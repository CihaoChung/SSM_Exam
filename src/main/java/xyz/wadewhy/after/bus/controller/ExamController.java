...
public class ExamController {
    ...
    public Map<String, Object> list(@RequestParam(name = "name", defaultValue = "") String name,
            ...
            @RequestParam(name = "endtime", required = false) String endtime, Page page) {
...
//        System.err.println(exam.toString());
        ...
        if (exam.getSinglequestionnum() == 0 && exam.getMuiltquestionnum() == 0 && exam.getWritequestionnum() == 0
                && exam.getChargequestionnum() == 0) {
            ret.put("type", "error");
