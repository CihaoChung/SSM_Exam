...
<link rel="stylesheet" type="text/css" href="${wadewhy}/resources/admin/easyui/css/wu.css" />
<link rel="stylesheet" type="text/css" href="${wadewhy}/resources/admin/easyui/css/icon.css" />
...
<div id="loading" style="position:absolute;z-index:1000;top:0px;left:0px;width:100%;height:100%;background:#FFFFFF;text-align :center;padding-top:6%;">
     <img src="${wadewhy}/resources/admin/easyui/images/loading.jpg" width="50%">
</div> 
	<!-- begin of header -->
    			...
    			<ul class="easyui-tree wu-side-tree">
                	<c:forEach items="${secondMenuList }" var="secondMenu">
                		...
                		<c:if test="${secondMenu.pid == topMenu.id }">
                			<li iconCls="${secondMenu.icon}"><a href="javascript:void(0)" data-icon="${secondMenu.icon}" data-link="${wadewhy}${secondMenu.href}?_mid=${secondMenu.id}" iframe="1">${secondMenu.title }</a></li>
                    	</c:if>
                    </c:forEach>
                </ul>
            </div>
    ...
    <div class="wu-main" data-options="region:'center'" style="width:1500px;">
        <div id="wu-tabs" class="easyui-tabs" data-options="border:false,fit:true">  
            <div title="首页" data-options="href:'${wadewhy}/after/sys/welcome.action',closable:false,iconCls:'icon-tip',cls:'pd3'"></div>
        </div>
    </div>
    <!-- end of main --> 
    <!-- begin of footer -->
