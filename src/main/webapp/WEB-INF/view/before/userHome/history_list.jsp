        	...
        	<table width="100%" cellpadding="10" border="0" class="tm_table_list">
                ...
                <tbody>
					...
					<tr>
						...
						<td>
							<a href="${wadewhy}/before/student/review_exam.action?examId=${history.exam.id }&examPaperId=${history.id}" target="_blank" class="tm_btn tm_btn_primary" style="text-decoration:none;color:white;" >回顾试卷</a>
						</td>
					</tr>
					</c:forEach>
                </tbody>
					...
					<tr>
						<td>
							<div class="tm_pager_foot">
								<a href="${wadewhy}/before/student/history_list.action?page=${page - 1}" class="tm_btns" style="color:white;text-decoration:none;">上一页</a>&nbsp;&nbsp;&nbsp;<font size="5" color="red"><b>${page}</b></font>&nbsp;&nbsp;&nbsp;<a href="history_list?page=${page + 1}" class="tm_btns" style="color:white;text-decoration:none;">下一页</a>&nbsp;
							</div>
						</td>
					</tr>
				</tfoot>
